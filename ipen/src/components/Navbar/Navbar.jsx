...
export const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center h-24 max-w-screen mx-auto px-14 text-white fixed top-0 left-0 right-0 bg-darkGreen font-poppins select-none shadow-lg z-50'>
