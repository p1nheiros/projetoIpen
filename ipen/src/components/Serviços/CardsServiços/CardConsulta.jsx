...
export const CardConsulta = () => {
    ...
    const message = "Olá, estou entrando em contato com a Clínica IPEN. Gostaria de obter mais informações sobre as consultas!";
                ...
                <div class="bg-white">
                    <div class="text-center px-3 pb-6 pt-2">
                        <p class="mt-4 font-light">
                            As consultas, serviços e procedimentos são agendadas por telefone, email ou whatsapp .
                        </p>
                    </div>
                    <div class="flex justify-center pb-3 text-slate-700">
                        <div class="text-center mr-3 pr-3 last:border-r-0 pt-[121px]">
                            <a href={whatsappLink}
                                target="_blank"
